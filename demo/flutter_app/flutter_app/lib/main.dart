...
class HomePage extends StatelessWidget {
  ...
  void validateInputs(BuildContext context) {
    ...
    // Validate email and password (you can customize these validations)
    ...
    // If validations pass, you can navigate to another screen or perform actions
    // For now, let's print the email and password to debug console
    print('Email: $email');
    print('Password: $password');
  }

  bool isValidEmail(String email) {
    // Simple email validation (you can add more complex logic if needed)
    return email.isNotEmpty && email.contains('@');
  }

  bool isValidPassword(String password) {
    // Simple password validation (you can add more complex logic if needed)
